...
Coordinates the GUI, DMX communication, effects, sensors, scenes, LEDs, and IR.
"""
...
from backend import dmx, effects, sensors, scenes, leds, ir
...
class DMXControllerApp(QWidget):
    ...
    def effects_tab(self):
        tab = QWidget()
        layout = QVBoxLayout()
        for effect in ["ColorChase", "Strobe", "Rainbow"]:
